...
import { DevelopementType } from '../../types/types'
import useAnimate from '../../hooks/useAnimate'
import imageConsts from '../../consts/imageConsts'

type componentType = {
    data: DevelopementType
}

const DevelopementCard = ({ data }: componentType) => {
    ...
    return (
        <TouchableOpacity style={styles.container} activeOpacity={0.8} onPress={handleOnPress}>
            ...
            {/* @ts-ignore */}
            <Image source={imageConsts.developementsImageMap[data.imageUrl]} style={styles.cardBackground}/>
...
export default DevelopementCard